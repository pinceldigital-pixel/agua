self.addEventListener('activate', (event) => {  try { clients.claim(); } catch(e){}});
self.addEventListener('install', (event) => {  try { self.skipWaiting(); } catch(e){}});
// service-worker.js
...
self.addEventListener('install', (event) => {
    ...
    // Podríamos cachear recursos aquí para que la app funcione offline
});
...
self.addEventListener('message', (event) => {
    if (event.data.action === 'stopNotifications') {
        ...
        console.log('Service Worker: Notificaciones detenidas.');
    }
    ...
    if (event.data.action === 'scheduleNotifications') {
        ...
        console.log('Service Worker: Programando notificaciones.');
